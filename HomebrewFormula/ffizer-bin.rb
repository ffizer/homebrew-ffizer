class FfizerBin < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
      ...
      sha256 "9e586cac24d63e32a80b3f56d38602ddd7f210fd3a5a81b20e1948f5b8c3cd05  /tmp/shasum_tmp"
  elsif OS.mac?
      url "https://github.com/ffizer/ffizer/releases/download/2.4.3/ffizer_2.4.3-aarch64-apple-darwin.tar.gz"
      sha256 "32a4fa453887685a9ad3fca382609937003106428c46304c69794f54afd74ad9  /tmp/shasum_tmp"
  elsif OS.linux?
      url "https://github.com/ffizer/ffizer/releases/download/2.4.3/ffizer_2.4.3-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "c1baadf1bedd2f9883ea1fa23866364231dd8cc57ea60ecd51a1040a6f4a6915  /tmp/shasum_tmp"
  end
